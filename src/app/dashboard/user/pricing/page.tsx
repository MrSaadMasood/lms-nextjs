  ...
  return (
    <section className="bg-violet-700 w-screen md:w-full md:h-full h-screen
      ...
      <h2 className="text-4xl md:text-6xl text-white  font-bold  h-20 w-full 
        flex justify-center items-center mt-2  " >Pricing</h2>
      <div className="w-full h-40  flexcol 
        ">
        <h3 className=" w-[80%] md:w-[50%] text-white   text-center flexrow
          md:text-xl  ">
          Take as many tests and you want. Measure you performance and get
          your stats visualized for better insight
        </h3>
      </div>
      <section className=" w-full h-[60rem] md:h-[40rem]    mt-2  flexrow
        mb-20 md:mb-0">
