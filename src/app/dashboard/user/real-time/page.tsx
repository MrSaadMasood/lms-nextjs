...
const CoinChart = dynamic(() =>
  import("@/components/Dashboard/RealTimeTable/CoinChart"),
  {
    loading: () => <p>loading</p>,
    ssr: false,
  })
...
export default function RealTimeVisualization() {
  ...
  return (
    <section className="bg-violet-700 w-screen md:w-full md:h-full h-screen
      ...
      <h2 className="text-2xl md:text-6xl text-white  font-bold  h-20 w-full 
      ...
      <div className=" w-full p-3 h-auto flex flex-col justify-center items-center overflow-hidden">
        {!params.has("coin") ?
          <RealTimeRouteTable showCoinChart={showCoinChart} /> :
          <CoinChart />}
