...
export default function PricingCard({
  ...
  return (
    <section className=" h-[80%] w-[97%] md:w-[40%] bg-white rounded-3xl  overflow-hidden
      hover:cursor-pointer  hover:shadow-2xl  duration-300  ">
      <header className="w-full h-[12%] flex justify-between  items-center font-bold text-xl p-2 
              bg-white mt-2 ">
        <h2>{heading}</h2>
      ...
      <div className="w-full h-[25%]  text-center 
              flexrow text-sm">
        <div className="w-[80%] h-full flexrow">
          {desc}
        </div>
      </div>
